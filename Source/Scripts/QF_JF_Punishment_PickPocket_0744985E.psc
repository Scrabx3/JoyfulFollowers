...
Scriptname QF_JF_Punishment_PickPocket_0744985E Extends Quest Hidden
...
Function Fragment_5()
;BEGIN AUTOCAST TYPE JFPunishmentGames
Quest __temp = self as Quest
JFPunishmentGames kmyQuest = __temp as JFPunishmentGames
;END AUTOCAST
;BEGIN CODE
